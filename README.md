# 说明
本项目改自[Black Dashboard React](https://demos.creative-tim.com/black-dashboard-react/#/dashboard) 模板
采用REACT框架
如有疑问请点击查看相关源码
本项目开发人员UI审美设计有限，直接采用别人审美的UI进行二次开发
主要应用组件
- react-charts-js2
...
- [说明](#说明)
- [Black Dashboard React ](#black-dashboard-react-)
